  ...
  <v-layout align-start>
    <v-flex>
      <v-toolbar flat color="white">
            ...
            <v-toolbar-title class="primary--text">Justificación de la Subvención</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-flex xs1>
              <v-select 
                v-model="select"
    ...
    methods: {
        ...
        pedirPDFAlServidor(idSolicitud, yearConvocatoria, nombreEntidad){
          ...
          axios('/reporte/certificadosEmpleoSubvenciones/'+idSolicitud, {
            ...
            link.href = fileURL;
            let nombreFichero = 'Certificados_Empleo_Subvención_RAPI_'+yearConvocatoria+'_'+nombreEntidad+'.pdf';
        ...
        imprimirPDF(item) {
            ...
            if (this.fechaLiquidacion==null || this.fechaLiquidacion=='') {
              console.log("Debes cumplimentar los datos antes de imprimir los certificados...");
            } else {
