            ...
            <v-card-text>
              <v-container grid-list-md>
                <v-layout wrap>
                  ...
                  <v-flex xs6>
                    <v-text-field type="date" v-model="fechaRequermientoSolicitud" label="Fecha Requerimiento Solicitud"
                    :value="fechaRequermientoSolicitud"></v-text-field>
                  </v-flex>
                  <v-flex xs6>
                  ...
                  <v-flex xs3>
                    <v-text-field type="number" v-model="importeAceptadoPersonal" label="Importe aceptado Personal"
                    :value="importeAceptadoPersonal"></v-text-field>
                  </v-flex>
                  <v-flex xs3>
                    <v-text-field type="number" v-model="importeAceptadoDietas" label="Importe aceptado Dietas"
                    :value="importeAceptadoDietas"></v-text-field>
                  </v-flex>
            ...
            <v-card-text>
              <v-container grid-list-md>
                ...
                <v-layout wrap>
                  ...
                  <v-flex xs6>
                    <v-text-field disabled type="date" v-model="fechaRequermientoSolicitud" label="Fecha Requerimiento Solicitud"
                    ></v-text-field>
                  </v-flex>
                  <v-flex xs6>
                  ...
                  <v-flex xs4>
                    <v-text-field disabled type="number" v-model="numeroDiasFuncionamiento" label="Número días funcionamiento"
                    ></v-text-field>
                  </v-flex>
                  <v-flex xs8></v-flex>
                  ...
                  <v-flex xs3>
                    <v-text-field disabled type="number" v-model="importeAceptadoPersonal" label="Importe aceptado Personal"
                    ></v-text-field>
                  </v-flex>
                  <v-flex xs3>
                    <v-text-field disabled type="number" v-model="importeAceptadoDietas" label="Importe aceptado Dietas"
                    ></v-text-field>
                  </v-flex>
                  ...
                  <v-flex xs3>
                    <v-text-field disabled type="text" v-model="numeroPropuestaDocumentoO" label="Número propuesta O"
                    ></v-text-field>
                  </v-flex>
                  <v-flex xs3>
...
export default {
    ...
    data() {
        return {
            ...
            importeAceptadoPersonal:'',
            importeAceptadoDietas:'',
    ...
    methods: {
        ...
        asiginarValores(item) {
          this.idSolicitud=item.idSolicitud;
            ...
            this.fechaRequermientoSolicitud=item.fechaRequermientoSolicitud;
            ...
            this.importeAceptadoPersonal=item.importeAceptadoPersonal;
            this.importeAceptadoDietas=item.importeAceptadoDietas;
            ...
            this.numeroPropuestaDocumentoO=item.numeroPropuestaDocumentoO;
            this.numeroDocumentoO=item.numeroDocumentoO;
            this.fechaPagoMaterialO=item.fechaPagoMaterialO;

            this.fechaAcuerdoInicioReintegro=item.fechaAcuerdoInicioReintegro;
            this.fechaAlegacionesAIR=item.fechaAlegacionesAIR;
            this.fechaResolucionReintegro=item.fechaResolucionReintegro;
            this.numeroModelo022=item.numeroModelo022;
            this.importeModelo022=item.importeModelo022;
            this.fechaNotificacionResolucionReintegro=item.fechaNotificacionResolucionReintegro;
            this.fechaAbonoReintegro=item.fechaAbonoReintegro;
        },
        ...
        limpiar() {
            ...
            this.fechaRequermientoSolicitud='';
            ...
            this.importeAceptadoPersonal='';
            this.importeAceptadoDietas='';
            ...
            this.numeroPropuestaDocumentoO='';
            this.numeroDocumentoO='';
            this.fechaPagoMaterialO='';

            this.fechaAcuerdoInicioReintegro='';
            this.fechaAlegacionesAIR='';
            this.fechaResolucionReintegro='';
            this.numeroModelo022='';
            this.importeModelo022='';
            this.fechaNotificacionResolucionReintegro='';
            this.fechaAbonoReintegro='';
        },
        ...
        modificar () {
            ...
            axios.put('/api/solicitud',{
              ...
              'fechaRequermientoSolicitud':me.fechaRequermientoSolicitud,
              ...
              'importeAceptadoPersonal':me.importeAceptadoPersonal,
              'importeAceptadoDietas':me.importeAceptadoDietas,
              ...
              'numeroPropuestaDocumentoO':me.numeroPropuestaDocumentoO,
