  ...
  <v-layout align-start>
    <v-flex>
      <v-toolbar flat color="white">
            ...
            <v-toolbar-title class="primary--text">Propuesta Concesión</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-flex xs1>
              <v-select 
                v-model="select"
    ...
    methods: {
        ...
        pedirPDFAlServidor(idSolicitud, yearConvocatoria, nombreEntidad){
          ...
          axios('/reporte/propuestaConcesion/'+idSolicitud, {
            ...
            link.href = fileURL;
            let nombreFichero = 'Propuesta_Resolución_Concesión_RAPI_'+yearConvocatoria+'_'+nombreEntidad+'.pdf';
